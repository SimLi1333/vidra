...
```sh
go install github.com/infrahub-operator/vidra/cli/vidra@latest
```
...
curl -LO https://github.com/infrahub-operator/vidra/releases/download/vX.Y.Z/vidra
chmod +x vidra
...
For more usage instructions, see the [Vidra CLI documentation](./usage.md).
